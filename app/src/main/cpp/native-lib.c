...
Java_studio_creater120_hapai_core_HapaiProxy_jniStartProxy(JNIEnv *env, __attribute__((unused)) jobject thiz, jobjectArray args) {
    if (g_proxy_running) {
...
JNIEXPORT jint JNICALL
Java_studio_creater120_hapai_core_HapaiProxy_jniStopProxy(__attribute__((unused)) JNIEnv *env, __attribute__((unused)) jobject thiz) {
...
JNIEXPORT jint JNICALL
Java_studio_creater120_hapai_core_HapaiProxy_jniForceClose(__attribute__((unused)) JNIEnv *env, __attribute__((unused)) jobject thiz) {
