...
class HapaiProxyService : LifecycleService() {
    private var proxy = HapaiProxy()
    private var proxyJob: Job? = null
    private val mutex = Mutex()

    companion object {
        private val TAG: String = HapaiProxyService::class.java.simpleName
