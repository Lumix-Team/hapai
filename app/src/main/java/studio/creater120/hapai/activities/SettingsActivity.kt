...
import studio.creater120.hapai.fragments.HapaiCMDSettingsFragment
import studio.creater120.hapai.fragments.HapaiUISettingsFragment
import studio.creater120.hapai.fragments.MainSettingsFragment
        ...
        when (openFragment) {
            "cmd" -> {
                supportFragmentManager
                    .beginTransaction()
                    .replace(R.id.settings, HapaiCMDSettingsFragment())
                    .commit()
            }
            "ui" -> {
                supportFragmentManager
                    .beginTransaction()
                    .replace(R.id.settings, HapaiUISettingsFragment())
                    .commit()
            }
            else -> {
                supportFragmentManager
